...
const productList = document.querySelector("tbody"); // Grab the tbody element from the page.
...
let itemDesc; // Just a string
let itemPrice;
let counter = 0; // Creating a counter such as for loops create i++
...
products.forEach((product) => {
	...
	//console.log(product); // display how the array is viewed
