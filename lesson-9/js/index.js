...
/* STEP 1: Create an object (looks a lot like declaring a variable, but with empty braces), then open this page in a browser and enter 'Coffee' in the console */ // Amethod isnide the function
function Coffee(size, isDecaf, qtyCream, qtySugar ){
    this.size = size;
    this.isDecaf = isDecaf;
    this.qtyCream = qtyCream;
    this.qtySugar = qtySugar;
    this.decaf = this.isDecaf ? "decaffineated" : "caffeinated";
    this.description = function () {
        /* A small sized caffineated coffee with 1 cream and two sugar.*/
...
let afiaCoffee = new Coffee("medium", false, 2, 1);
output.textContent = afiaCoffee.description();
...
let batiyahCoffee = Object.create(afiaCoffee);
// if I want to add new values
batiyahCoffee.size = "large";
batiyahCoffee.isDecaf = "true";
batiyahCoffee.qtyCream = "1";
batiyahCoffee.qtySugar = "0";
...
let zaneCoffee = new batiyahCoffee.constructor("small", true, 3, 3);
