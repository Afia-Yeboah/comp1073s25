...
let myInt = 5;
let myFloat = 6.3456;
let myDouble = 7.89739237398002;
let myBinary = 0B0100110000101;
let myHex = 0X04F6E2;
let myBitwise = -~-~-~0;
...
let step2a = 5 + 2; //change the operators to get the corresponding answers
...
let step3 = 5;
// step 3++ or step3 -- in the console is different than:
// ++ step3 or -- step3
...
let step4 = 5;
step4 *=2; // Or step4 = step4 + 2; this can be used with any of the operator symbols
console.log(step4);
